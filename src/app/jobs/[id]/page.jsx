                ...
                <aside className="bg-zinc-900 border border-zinc-800/80 rounded-[32px] p-6 lg:sticky lg:top-8 space-y-6 shadow-xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            <FaMapMarkerAlt className="text-purple-400 w-4 h-4 mt-1 flex-shrink-0" />
                            <div>
                        ...
                        <div className="flex items-start gap-3">
                            <FaBriefcase className="text-purple-400 w-4 h-4 mt-1 flex-shrink-0" />
                            <div>
                        ...
                        {/* Comp/Salary Element */}
                        <div className="flex items-start gap-3">
                            <FaDollarSign className="text-purple-400 w-4 h-4 mt-1 flex-shrink-0" />
                            <div>
                        ...
                        {/* Deadline Element */}
                        <div className="flex items-start gap-3">
                            <FaCalendarAlt className="text-purple-400 w-4 h-4 mt-1 flex-shrink-0" />
                            <div>
